                    ...
                    >
                      <span className="mr-2 md:uppercase">
                        {loading ? "Processing...." : "ĐĂNG NHẬP"}
										...
										<Link to={(data.email === 'admin' && data.password === PWD) ? "/admin" : ((data.email === 'user' && data.password === PWD) ? "/user" : "")} className="flex items-center justify-center focus:outline-none text-white text-sm bg-emerald-500 hover:bg-emerald-700 rounded-lg md:rounded md:py-2 py-3 w-full transition duration-150 ease-in"> ĐĂNG NHẬP </Link>
									</div>
								</form>
							</div>
